        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Note v1</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
              <div class="col-md-7">
                                ...
                                <div class="card">
                                      ...
                                      <?php 
                                          ...
                                          {
                                            $sql = "SELECT * FROM `tblnotes` WHERE nID ='".$_GET['playID']."'  ";
                                                  ...
                                                  if (mysqli_num_rows($result) > 0) {
                                                      ...
                                                      while($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo'
                                                        <input type="hidden" name="vid" id="vidID" value='.$row['nID'].' class="form-control">
                                                        <input type="hidden" name="commentby" value='. $_SESSION["username"] .' class="form-control">
                                                          <div class="position-relative">
                                                          <embed src=../controller/uploads/'.$row['noteDocument'].'  width="100%" height="600" type="application/pdf">
                                                          </div>
                                                       ';
                                                          }
                                                      } else {
              ...
              <div class="col-md-5">
                                ...
                                <div class="card">
                                      <div class="card-body">
                                      <?php
                                        $sql = "SELECT * FROM `tblvideos` limit 4";
