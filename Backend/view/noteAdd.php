            ...
            <div class="card card-primary card-outline card-tabs">
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">All Notes</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Add Notes</a>
                  </li>
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <td>".$row['nID']."</td>
                                <td>".$row['noteTitle']."</td>
                                <td><a class='btn btn-success' href=noteEdit.php?enID=".$row['nID']."> Edit</a></td>
                                <td><a class='btn btn-danger' href=../controller/cateNoteController.php?dnID=".$row['nID']."> Delete </a></td>
                                </tr>";
                                }
                            } else {
                                echo "0 results";
                  ...
                  <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
                    ...
                    <form action="../controller/cateNoteController.php" method="post" enctype="multipart/form-data">
                      <div class="mb-3">
                        ...
                        <input type="text" name="noteName" class="form-control" id="exampleFormControlInput1" required>
                      </div>
                      ...
                      <div class="mb-3">
                        <label for="formFileMultiple" class="form-label">Note Document </label>
                        <input type="file" class="form-control"   name="image" required id="exampleInputPassword1" >
                     </div>
                     <input  type="submit" name="noteAdd" class="btn btn-primary mt-3" value="Add New Note">
                    </form>
